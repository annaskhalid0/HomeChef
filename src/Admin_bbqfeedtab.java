 ...
 * @author IT Garage
 */
public class Admin_bbqfeedtab extends javax.swing.JFrame {

    Connection conn = null ;
    PreparedStatement pst;
    ResultSet rs;
    public Admin_bbqfeedtab() {
        initComponents();
        conn = DBC.ConnecrDB();
         bbqfeedback();
    }

    public void bbqfeedback()
    {
        try {
             ...
             DefaultTableModel desitab = (DefaultTableModel) Admin_bbqfeedback.getModel();
             ...
             Logger.getLogger(Admin_bbqfeedtab.class.getName()).log(Level.SEVERE, null, ex);
         }
    }
    ...
    private void initComponents() {
        ...
        Admin_bbqfeedback = new javax.swing.JTable();
        ...
        Admin_bbqfeedback.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(Admin_bbqfeedback);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_bbqfeedtab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_bbqfeedtab().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTable Admin_bbqfeedback;
