 ...
 * @author IT Garage
 */
public class Admin_desifeedtab extends javax.swing.JFrame {

    Connection conn = null ;
    PreparedStatement pst;
    ResultSet rs;
    public Admin_desifeedtab() {
        initComponents();
         conn = DBC.ConnecrDB();
         desifeedback();
    }
    ...
    public void desifeedback()
    {
        try {
            ...
            head.setFont(font);
             ...
             DefaultTableModel desitab = (DefaultTableModel) Admin_desifeedback.getModel();
             ...
             Logger.getLogger(Admin_desifeedtab.class.getName()).log(Level.SEVERE, null, ex);
         }
    }
    ...
    private void initComponents() {
        ...
        Admin_desifeedback = new javax.swing.JTable();
        ...
        Admin_desifeedback.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(Admin_desifeedback);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_desifeedtab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_desifeedtab().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTable Admin_desifeedback;
