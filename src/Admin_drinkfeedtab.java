 ...
 * @author IT Garage
 */
public class Admin_drinkfeedtab extends javax.swing.JFrame {

    Connection conn = null ;
    PreparedStatement pst;
    ResultSet rs;
    public Admin_drinkfeedtab() {
        initComponents();
        conn = DBC.ConnecrDB();
        drinksfeedback();
    }

     public void drinksfeedback()
    {
        try {
             ...
             DefaultTableModel desitab = (DefaultTableModel) Admin_drinkfeedback.getModel();
             ...
             Logger.getLogger(Admin_drinkfeedtab.class.getName()).log(Level.SEVERE, null, ex);
         }
    }
    ...
    private void initComponents() {
        ...
        Admin_drinkfeedback = new javax.swing.JTable();
        ...
        Admin_drinkfeedback.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(Admin_drinkfeedback);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_drinkfeedtab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_drinkfeedtab().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTable Admin_drinkfeedback;
