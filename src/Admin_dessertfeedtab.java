 ...
 * @author IT Garage
 */
public class Admin_dessertfeedtab extends javax.swing.JFrame {
    Connection conn = null ;
    PreparedStatement pst;
    ResultSet rs;
    public Admin_dessertfeedtab() {
        initComponents();
        conn = DBC.ConnecrDB();
        dessertfeedback();
    }

    public void dessertfeedback()
    {
        try {
             ...
             DefaultTableModel desitab = (DefaultTableModel) Admin_dessertfeedback.getModel();
             ...
             Logger.getLogger(Admin_dessertfeedtab.class.getName()).log(Level.SEVERE, null, ex);
         }
    }
    ...
    private void initComponents() {
        ...
        Admin_dessertfeedback = new javax.swing.JTable();
        ...
        Admin_dessertfeedback.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(Admin_dessertfeedback);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_dessertfeedtab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_dessertfeedtab().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTable Admin_dessertfeedback;
